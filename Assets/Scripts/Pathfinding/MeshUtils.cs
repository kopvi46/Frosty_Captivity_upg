...
public static class MeshUtils {
    ...
    public static void AddToMeshArrays(Vector3[] vertices, Vector2[] uvs, int[] triangles, int index, Vector3 pos, float rot, Vector3 baseSize, Vector2 uv00, Vector2 uv11)
    {
        ...
        Vector3 halfBaseSize = baseSize * 0.5f;

        vertices[vIndex0] = pos + new Vector3(-halfBaseSize.x, 0, -halfBaseSize.z);
        vertices[vIndex1] = pos + new Vector3(-halfBaseSize.x, 0, halfBaseSize.z);
        vertices[vIndex2] = pos + new Vector3(halfBaseSize.x, 0, halfBaseSize.z);
        vertices[vIndex3] = pos + new Vector3(halfBaseSize.x, 0, -halfBaseSize.z);
